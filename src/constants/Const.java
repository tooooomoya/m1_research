...
public class Const {
    ...
    public static final double LIKE_INCREASE_WEIGHT = 0.01;
    public static final double FOLLOW_INCREASE_WEIGHT = 0.2;
    ...
    public static final int MAX_READABLE_POSTS_NUM = 50;

    // follow parameter
    public static final double INITIAL_FOLLOW_RATE = 0.5;

    // unfollow parameter
     public static final double INITIAL_UNFOLLOW_RATE = 0.5;
